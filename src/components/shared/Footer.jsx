      ...
      <div className={classOfMain}>
        ...
        <div className={classes["info-container"]}>
          ...
          <div className={classes["social-icons"]}>
            <motion.a href="#facebook" whileHover={{ y: -2 }}>
            ...
            <motion.a href="#youtube" whileHover={{ y: -2 }}>
              <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <motion.a href="#twitter" whileHover={{ y: -2 }}>
            ...
            <motion.a href="#pinterest" whileHover={{ y: -2 }}>
              <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <motion.a href="#instagram" whileHover={{ y: -2 }}>
              <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                <path
